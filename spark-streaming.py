...
if __name__ == "__main__":
    spark = (SparkSession.builder \
            ...
            .config('spark.jars.package', 'org.apache.spark:spark-sql-kafka-0-10_2.13:4.0.0')  # spark kafka integration
            .config('spark.jars', 'C:\Users\PALIW\Desktop\realtime-voting-system\postgresql-42.7.7.jar')  # postgresql driver
    ...
    votes_per_candidate_to_kafka = (votes_per_candidate.selectExpr('to_json(struct(*)) AS value')
                                    ...
                                    .option('checkpointLocation', 'C:\Users\PALIW\Desktop\realtime-voting-system\checkpoints\checkpoint1')
                                    .outputMode('update')
                                    .start()
                                    )
    ...
    turnout_by_location_to_kafka = (turnout_by_location.selectExpr('to_json(struct(*)) AS value')
                                    ...
                                    .format('kafka')
                                    .option('kafka.bootstrap.servers', 'localhost:9092')
                                    .option('topic', 'aggregated_votes_by_location')
                                    .option('checkpointLocation', 'C:\Users\PALIW\Desktop\realtime-voting-system\checkpoints\checkpoint2')
                                    .outputMode('update')
                                    .start()
                                    )
